module.exports = {
  ...
  ERROR_MSGS: {
    ...
    INCORRECT_PASSWORD:
      "The old password you entered is incorrect. Please provide the correct password.",
  ...
  INFO_MSGS: {
    ...
    VERIFY_SUCCESSFULLY: "User verification successfully.",
    UNVERIFY_SUCCESSFULLY: "User unverification successfully.",
    SUCCESSFUL_LOGIN: "You have logged in successfully.",
    SUCCESS: "The request was processed successfully.",
    OTP_VERIFIED: "The OTP has been verified successfully.",
    PASSWORD_CHANGED: "Your password has been changed successfully.",
    REPORT_ADDED: "The report has been added successfully.",
    FORGOT_PASSWORD:
      "Your password has been changed successfully. Please log in to your account.",
    SEND_USER_TO_CARRIER_REQUEST:
      "Your request has been sent to the carrier for approval. Please wait for their response.",
    SUCCESSFUL_REGISTER: "Your registration with Yhoty was successful.",
    OTP_SENT_SUCC:
